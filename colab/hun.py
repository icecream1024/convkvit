...
def validate(epoch):
    ...
    # 记录到wandb
    wandb.log({
        "val_confusion_matrix": wandb.Image(cm_image, caption=f"Epoch {epoch + 1} Validation Confusion Matrix")
    })
...
def test_model(epoch):
    ...
    # 记录到wandb
    wandb.log({
        "test_confusion_matrix": wandb.Image(cm_image, caption=f"Epoch {epoch + 1} Test Confusion Matrix")
    })
